...
const SignIn = () => {
  ...
  return (
    <div className="max-w-md w-full md:overflow-hidden mx-auto rounded-xl p-4 md:p-8 min-h-full shadow-input bg-white dark:bg-black">
          ...
          <LabelInputContainer className="mb-4">
            <div className="flex justify-between items-center">
              ...
              <Link
                ...
                className="font-medium text-xs text-primary-600  dark:text-blue-500 text-blue-600 hover:text-blue-800 dark:hover:text-blue-700"
              >
                Forget Password?
              </Link>
            </div>
